    ...
    return (
        <>
            <div className='fixed top-3 left-3 z-10'>
                <svg className='w-30' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103 44">
            ...
            <div className='fixed top-0 right-0 z-10 cursor-pointer'>
                <div className=' bg-black h-13 w-60 group relative'>
                    <div className='w-12 h-[1.2px] bg-white absolute top-5 right-10 group-hover:bg-black z-20'></div>
                    <div className='w-7 h-[1.2px] bg-white absolute top-7 right-10 group-hover:bg-black z-20'></div>
                    <span className='bg-[#d3fd50] absolute top-0 w-full h-0 group-hover:h-full transition-all duration-100 ease-in'></span>
                </div>
            </div>
        </>
    )
